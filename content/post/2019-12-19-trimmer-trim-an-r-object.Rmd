---
title: '"trimmer" - trim an R object'
author: smaakagen
date: '2019-12-19'
slug: trimmer-trim-an-r-object
categories: ["R"]
...
library(trimmer)
```
<img src="https://raw.githubusercontent.com/smaakage85/trimmer/master/man/figures/hex_trimmer.png" align="right" height=250/>
...
<iframe src="https://open.spotify.com/embed/track/4ABWPP59ItFKykdaDF09K5" width="300" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
...
You can choose, that certain elements _MUST NOT_ be removed during the trimming process. Do this with the `dont_touch` argument.
