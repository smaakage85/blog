...
```
<img src="https://github.com/smaakage85/dockr/blob/master/man/figures/dockr.png?raw=true" align="right" height=250/>

## `dockr` now on CRAN

`dockr` 0.8.4 is now available on CRAN. `dockr` is a minimal toolkit to build a 
...
<iframe src="https://open.spotify.com/embed/track/5IR7Ui6MB7MrFZfF5hsoIH" width="300" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
...
my 'dockr' package lives in a folder called `docker`, I call the function like
this:
