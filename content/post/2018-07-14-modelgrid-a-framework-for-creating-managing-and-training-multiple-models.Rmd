...
[`modelgrid`](https://cran.r-project.org/web/packages/modelgrid/index.html) is
...
and train a portfolio of [`caret`](https://cran.r-project.org/web/packages/modelgrid/index.html)
...
fitted model is deleted, so that everything is in sync.
...
That's it! You should now be all set to grind models with the `modelgrid`!
